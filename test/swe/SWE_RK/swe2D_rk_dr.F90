 ...
 !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     use swe2dxy_parameters,only:u_par,f_par,feigvalues_par,geigvalues_par,jf
     implicit none
     integer :: nvar
     double precision ::t
 ...
 !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
       use swe2dxy_parameters,only:temp_par,fz_par,feigvalues_par,geigvalues_par
       implicit none
       integer :: nvar
       double precision :: t
       ...
       open(unit=2010,file='swe_rk_lsode_sol.txt',form='formatted')
       do i=1,ndim
 ...
 !     *****errors are shown in the form ||delta(x)||/||x||*****
  ...
  2010   format (2x,'time interval [',f5.2,'-',f5.2, ']    nsteps=',i5,&
                   ' nasteps=',i5,' nrsteps=',i5,/,2x,&
                     'cputime=', f14.3,'seconds',/,2x,'rerror=',f12.8,//)
