...
!      close(11)
    ...
    subroutine output_sen(n,ntlm,y_tlm,fno)
      ...
      write(fname,'(a,i3.3,a)') 'SD_TLM_',fno,'.m'
...
!       rcntrl(3)=1e-3
       ...
       call cpu_time(t1)
       call integrate_tlm(tin=tstart, tout=tend, n=ndim,nnzero=nnz, &
       ...
       call output_sen(ndim,ntlm,y_tlm,j)
     end do
